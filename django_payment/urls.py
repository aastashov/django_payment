...
urlpatterns = [
    ...
    url(r'^user/add_bookmark/(?P<prov_id>\S+)/$', profiles_views.add_bookmark, name='add_bookmark'),
    url(r'^user/del_bookmark/(?P<prov_id>\S+)/$', profiles_views.del_bookmark, name='del_bookmark'),
